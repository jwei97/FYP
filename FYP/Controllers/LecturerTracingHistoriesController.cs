...
{
    public class LecturerTracingHistoriesController : Controller
    {
        private readonly FYPContext _context;

        public LecturerTracingHistoriesController(FYPContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.TracingHistory.Where(x=> x.Type == SecurityConstants.ACCOUNT_TYPE_STUDENT)
            .ToListAsync());
        }
