...
namespace FYP.Controllers
{
    public class AdminDocumentsController : Controller
    {
        ...
        public AdminDocumentsController(FYPContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create( Document document, IFormFile files)
        {
            if (ModelState.IsValid)
            {
                ...
                CloudBlockBlob blob = container.GetBlockBlobReference(Guid.NewGuid().ToString() + System.IO.Path.GetExtension(files.FileName));
